...
GROUP_EXCEPTION_STRING = "'NoneType' object has no attribute 'group'"
...
try:
    ...
    title_read = desc_read = cat_read = \
        date_read = content_read = access_log_file
    ...
    if str(e) == GROUP_EXCEPTION_STRING:
        print("GROUP_EXCEPTION_STRING: Unable To Parse The File Without Tags")
